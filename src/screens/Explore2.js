import { View, Text, TextInput, ScrollView,  ImageBackground, Image, Dimensions, KeyboardAvoidingView, Modal } from 'react-native'
...
export default function Explore2() {
    ...
    return (
        <SafeAreaView style={[style.area, { backgroundColor: Colors.primary }]}>
            <ImageBackground source={theme.maplocation2} resizeMode='stretch' style={{ height: height, width: width, }}>
